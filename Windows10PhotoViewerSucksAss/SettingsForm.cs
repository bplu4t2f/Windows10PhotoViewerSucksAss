...
namespace Windows10PhotoViewerSucksAss
{
	partial class SettingsForm : Form
	{
		public SettingsForm(Form1 owner)
		{
			...
			this.settingHelper.Add(new CheckBoxSetting("SortCaseSensitive", this.checkBoxSortCaseSensitive), Form1.Setting_SortCaseSensitive);
			this.settingHelper.Add(new ColorSetting("BackgroundColor", this.buttonBackgroundColor), Form1.Setting_BackColor);
			this.settingHelper.Add(new ColorSetting("FileListBackColor", this.buttonFileListBackColor), Form1.Setting_FileListBackColor);
			this.settingHelper.Add(new ColorSetting("FileListForeColor", this.buttonFileListForeColor), Form1.Setting_FileListForeColor);
			this.settingHelper.Add(new ColorSetting("FileListForeColorError", this.buttonFileListForeColorError), Form1.Setting_FileListForeColorError);
			this.settingHelper.Add(new FontSetting("Font", this.buttonChangeFont, this.labelCurrentFont), Form1.Setting_ApplicationFont);
			this.settingHelper.Add(new IntSliderSetting("SplitterWidth", this.trackBarSplitterWidth, this.labelSplitterWidth), Form1.Setting_SplitterWidth);
			var comboBox_mouseWheelMode = 
				this.settingHelper.Add(new ComboBoxSetting<MouseWheelMode>("MouseWheelMode", this.comboBoxMouseWheelMode), Form1.Setting_MouseWheelMode);
			this.settingHelper.Add(new CheckBoxSetting("UseCurrentImageAsWindowIcon", this.checkBoxUseCurrentImageAsWindowIcon), Form1.Setting_UseCurrentImageAsWindowIcon);
